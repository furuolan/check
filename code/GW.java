...
public class GW{
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i=0;i<size.length;i++){
			...
			gw.valueIteration("./output/"+head+"/GridWorld_"+size[i]);
			System.out.println("-------------Policy Iteration-------------");
			gw.policyIteration("./output/"+head+"/GridWorld_"+size[i]);
		}
				head = "prob";
		System.setOut(dos);
		System.out.println(head);
		...
		for(int i=0;i<prob.length;i++){
			...
			MyGridWorld gw = new MyGridWorld(map, 5, -0.1, 0.99);
			System.out.println("-------------Value Iteration-------------");
			gw.valueIteration("./output/"+head+"/GridWorld_"+prob[i]);
			System.out.println("-------------Policy Iteration-------------");			
			gw.policyIteration("./output/"+head+"/GridWorld_"+prob[i]);
		}
		...
		for(int i=0;i<wallpercent.length;i++){
			...
			MyGridWorld gw = new MyGridWorld(map, 5, -0.1, 0.99);
			System.out.println("-------------Value Iteration-------------");
			gw.valueIteration("./output/"+head+"/GridWorld_"+wallpercent[i]);
			System.out.println("-------------Policy Iteration-------------");				
			gw.policyIteration("./output/"+head+"/GridWorld_"+wallpercent[i]);
		}
		...
		for(int i=0;i<reward.length;i++){
			...
			System.out.println("-------------Value Iteration-------------");
			gw.valueIteration("./output/"+head+"/GridWorld_"+reward[i]);
			System.out.println("-------------Policy Iteration-------------");
			gw.policyIteration("./output/"+head+"/GridWorld_"+reward[i]);
		}
		...
		for(int i=0;i<discount.length;i++){
			...
			System.out.println("-------------Value Iteration-------------");
			gw.valueIteration("./output/"+head+"/GridWorld_"+discount[i]);
			System.out.println("-------------Policy Iteration-------------");
			gw.policyIteration("./output/"+head+"/GridWorld_"+discount[i]);
		}
		...
		for(int i=0;i<qInit.length;i++){
			...
			gw.QLearning("./output/"+head+"/GridWorld_"+qInit[i], qInit[i], 0.1, 0.1);
		}
		...
		for(int i=0;i<epsilon.length;i++){
			...
			MyGridWorld gw = new MyGridWorld(map, 5, -0.1, 0.99);
			System.out.println("-------------Q Learning-------------");
			gw.QLearning("./output/"+head+"/GridWorld_"+epsilon[i], 0.3, 0.1, epsilon[i]);
		}
		System.setOut(dos);
